...
/* Add Lesson Box */
.add-box {display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:200px; border:2px dashed var(--bgcol); border-radius:10px; cursor:pointer; text-align:center; padding:20px; transition:all 0.3s ease; background:rgba(44,130,201,0.1);}
.add-box:hover {background:rgba(44,130,201,0.2); transform:translateY(-5px);}
...
<h1 class="heading">Social Media Lessons</h1>
    ...
    <div class="add-box" id="addBox">
        ...
        <div class="add-form" id="addForm">
            <form method="POST">
                ...
                <input type="text" name="file" placeholder="Lesson File (ex: watch-socialfb.html)" required>
...
document.getElementById("cancelAdd").addEventListener("click", function(){
    ...
    box.querySelector('h3').style.display='block';
});
</script>
</body>
</html>
